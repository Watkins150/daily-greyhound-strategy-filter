...
STRATEGIES={'Nottingham':{'name':'UK LAY Nottingham Trap 6','traps':{6:(1.01,100)}},'Central Park':{'name':'UK LAY Central Park Trap 3,4','traps':{3:(10,110),4:(10,110)}},'Monmore':{'name':'UK LAY Monmore Trap 2,5,6','traps':{2:(4,100),5:(4,100),6:(4,100)}},'Doncaster':{'name':'UK LAY Doncaster Trap 2,6','traps':{2:(6,120),6:(6,120)}},'Harlow':{'name':'UK LAY Harlow Trap 2,4','traps':{2:(12,100),4:(12,100)}},'Valley':{'name':'UK LAY Valley Trap 1,3,4','traps':{1:(4,100),3:(4,100),4:(4,100)}},'Sunderland':{'name':'UK LAY Sunderland Trap 4','traps':{4:(9,100)}},'Towcester':{'name':'UK LAY Towcester Trap 1,5,6','traps':{1:(4,100),5:(4,100),6:(4,100)}},'Kinsley':{'name':'UK LAY Kinsley Trap 5,6','traps':{5:(4,100),6:(4,100)}},'Yarmouth':{'name':'UK LAY Yarmouth Trap 1,3,6','traps':{1:(6,50),3:(6,50),6:(6,50)}}}
SOURCE_CONFIG='authoritative 10-strategy six-runner baseline 2026-08-29; Oxford, Swindon and Romford removed'
